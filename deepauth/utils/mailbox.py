...
def send_mail(username, password, receiver, subject, content, host, port=465):
    """
    发送邮件
    :param username: 邮箱账号
    :param password: 邮箱密码
    :param receivers: 邮箱接收人地址
    :param subject: 邮件标题
    :param content: 邮件内容
    :param host: 邮箱服务器
    :param port: 端口号
    ...
    smtp.sendmail(username, receiver, msg.as_string())  # 参数分别是发送者，接收者，第三个是把上面的发送邮件的内容变成字符串
